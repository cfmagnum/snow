...
public class ApiController {
	...
	public ResponseEntity<String> associateManagerWithSpaceByUsername(Model model, @RequestBody String json) throws JsonParseException, JsonMappingException, IOException {
	   ...
	   // String userEmailId =(String) requestParams.get("userEmailId");
	    ...
	    String url= "https://api.sys.eu.cfdev.canopy-cloud.com/v2/spaces/" + spaceGuid + "/managers";
